    ...
    def get_sample(self):
        ...
        for sample in self.list_sample:
            ...
            for ctx in context:
                ...
                len_context = self.max_seq_length - len(text_question) - 2
                if len(text_context) > len_context:
                  text_context = text_context[:len_context]
